package com.arfan.shop.security.config;

import com.arfan.shop.security.AuthTokenFilter;
import com.arfan.shop.security.jwt.JwtAuthEntryPoint;
...
public class ShopConfig {
    ...
    private static final List<String> SECURED_URLS =
            List.of("/api/v1/cart/**", "/api/v1/item/**");
